...
export async function log_activity({ user_id, action, entity, entity_id, description, ip_address, user_agent }) {
  return prisma.activity_logs.create({ data: { user_id, action, entity, entity_id, description, ip_address, user_agent } });
}
export async function find_activity_logs({ user_id, action, page=1, limit=20, start_date, end_date }={}) {
