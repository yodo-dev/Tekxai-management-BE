...
import { get_schema, run_report, run_aggregate, run_kpi, list_saved, save_report, delete_saved, export_excel, export_pdf } from '../report_builder.controller.js';
...
router.post('/builder/kpi', MANAGER, run_kpi);
