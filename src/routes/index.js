...
import business_units_routes from '../modules/business-units/routes/business-units.routes.js';
import hr_documents_routes  from '../modules/hr-documents/routes/hr-documents.routes.js';
...
router.use('/business-units',    business_units_routes);
router.use('/hr-documents',      hr_documents_routes);
